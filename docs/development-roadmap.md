...
Phase 1〜4は完了した。現在地は**Phase 5**であり、Family Issue brokerのcodeとCIは完成している。残作業は、専用GitHub Appと実repositoryを使う承認付き実host smokeである。Phase 5を閉じた後にPhase 6へ進む。
...
1. Phase 5のFamily実host smokeを完了する。
