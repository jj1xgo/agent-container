...
| normal latest rebuild | no fixed version flags; CA bootstrap then persistent Debian HTTPS source; cachebuster invalidates CLI install; both public versions resolve | `bin/agentctl build` exit 0; main APT metadata/packages used `https://deb.debian.org`; image source records both HTTPS URIs; `localhost/agent-container:dev` image `0391ee6958cb6ca37f00d074391a819d31edc05e3e79464add851c8fbe8c4973`; Node `v26.7.0`; Codex `0.149.1`; Claude `2.1.243` | 2026-08-25 |
