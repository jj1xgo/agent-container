...
| normal latest rebuild | no fixed version flags; cachebuster invalidates CLI install; both public versions resolve | `bin/agentctl build` exit 0; CLI install step executed; `localhost/agent-container:dev` image `21752c72adbcac71e5b8ec40ca02ab149346d872fd3cf5bb282b2eb3d132c84a`; Node `v26.7.0`; Codex `0.149.1`; Claude `2.1.243` | 2026-08-25 |
